_base_ = ["UniAD/projects/configs/_base_/datasets/nus-3d.py",
          "UniAD/projects/configs/_base_/default_runtime.py"]
...
model = dict(
    ...
    img_backbone=dict(
        ...
        norm_eval=True,
        pretrained="my_bev/carla_bev_backbone_best.pth",  # 우리가 학습시킨 모델 사용
    ),
